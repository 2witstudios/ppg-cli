...
If you discover a security vulnerability in pogu-cli, please report it responsibly.
...
pogu-cli runs locally and executes shell commands (tmux, git, agent CLIs) on your machine. Security concerns include:
